...
from models.sequential.FuXiAlpha import FuXiAlpha
...
if __name__ == '__main__':
	...
	if init_args.model_name == 'FuXiAlpha':
		model_name = FuXiAlpha
	elif init_args.model_name == 'BPRMF':
		from models.general.BPRMF import BPRMF # 确保 BPRMF 也能跑
		model_name = BPRMF
	else:
        # 兼容其他模型
		model_name = eval('{0}.{0}{1}'.format(init_args.model_name,init_args.model_mode))
